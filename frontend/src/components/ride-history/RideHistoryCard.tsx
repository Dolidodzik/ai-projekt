...
import { formatDurationMinutes, formatSearchDate } from './types'
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-1 flex-col gap-3 p-4 md:p-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <InfoSlot label="Czas przejazdu" placeholder="Brak danych">
              {ride.duration_minutes ? (
                <p className="font-medium text-slate-900">{formatDurationMinutes(ride.duration_minutes)}</p>
              ) : null}
            </InfoSlot>
          </div>
