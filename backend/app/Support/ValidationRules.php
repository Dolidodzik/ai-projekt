...
{
    /** Letters, numbers, spaces and common name punctuation (Unicode). */
    public const PERSON_NAME_REGEX = '/^[\p{L}\p{M}\p{N}\s\-\.\']+$/u';

    /** Report / ticket titles — no control characters. */
    ...
    /**
     * Fields that must never be set by clients on user-facing endpoints.
     *
     * @return list<string>
     */
